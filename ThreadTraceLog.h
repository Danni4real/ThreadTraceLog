...
#define log_info(...)  ThreadTraceLog::log(FILENAME_, __LINE__, 'I', printf_to_string(__VA_ARGS__))
#define log_warn(...)  ThreadTraceLog::log(FILENAME_, __LINE__, 'W', printf_to_string(__VA_ARGS__))
#define log_error(...) ThreadTraceLog::log(FILENAME_, __LINE__, 'E', printf_to_string(__VA_ARGS__))
#define log_debug(...) ThreadTraceLog::log(FILENAME_, __LINE__, 'D', printf_to_string(__VA_ARGS__))
